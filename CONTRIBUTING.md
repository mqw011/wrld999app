...
- Make sure to check if an [issue exists](https://github.com/shad0wrider/wrld999/issues) already & see if the issue is assigned to anyone or not.
...
If you spot something new, open an issue using a [template](https://github.com/shad0wrider/wrld999/issues/new/choose). We'll use the issue to have a conversation about the problem you want to fix.
...
Once your PR is merged, you will be proudly listed as a contributor in the [contributor chart](https://github.com/shad0wrider/wrld999/graphs/contributors).
