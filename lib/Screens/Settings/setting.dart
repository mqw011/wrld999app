...
import 'package:wrld999/Helpers/github.dart';
import 'package:wrld999/Helpers/picker.dart';
import 'package:wrld999/Helpers/update.dart';
import 'package:wrld999/Screens/Home/saavn.dart' as home_screen;
import 'package:wrld999/Screens/Settings/player_gradient.dart';
import 'package:wrld999/Screens/Top Charts/top.dart' as top_screen;
import 'package:wrld999/Services/ext_storage_provider.dart';
import 'package:wrld999/localization/app_localizations.dart';
import 'package:wrld999/main.dart';
...
class _SettingPageState extends State<SettingPage>
  ...
  String autoBackPath = Hive.box('settings').get(
    'autoBackPath',
    defaultValue: '/storage/emulated/0/wrld999/Backups',
  ) as String;
                        ...
                        ListTile(
                          ...
                          trailing: TextButton(
                            ...
                            onPressed: () async {
                              autoBackPath =
                                  await ExtStorageProvider.getExtStorage(
                                        dirName: 'wrld999/Backups',
                                        writeAccess: true,
                                      ) ??
                                      '/storage/emulated/0/wrld999/Backups';
                              Hive.box('settings')
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            const String upiUrl =
                                'upi://pay?pa=ankit.sangwan.5688@oksbi&pn=wrld999';
                            launchUrl(
                              Uri.parse(upiUrl),
                              mode: LaunchMode.externalApplication,
                            );
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                launchUrl(
                                                  Uri.parse(
                                                    'https://mail.google.com/mail/?extsrc=mailto&url=mailto%3A%3Fto%3Dwrld999youcantescape%40gmail.com%26subject%3DRegarding%2520Mobile%2520App',
                                                  ),
                                                  mode: LaunchMode
                                                      .externalApplication,
                                                );
