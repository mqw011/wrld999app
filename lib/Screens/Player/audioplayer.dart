...
import 'package:wrld999/CustomWidgets/add_playlist.dart';
import 'package:wrld999/CustomWidgets/animated_text.dart';
import 'package:wrld999/CustomWidgets/copy_clipboard.dart';
import 'package:wrld999/CustomWidgets/download_button.dart';
import 'package:wrld999/CustomWidgets/empty_screen.dart';
import 'package:wrld999/CustomWidgets/equalizer.dart';
import 'package:wrld999/CustomWidgets/gradient_containers.dart';
import 'package:wrld999/CustomWidgets/like_button.dart';
import 'package:wrld999/CustomWidgets/popup.dart';
import 'package:wrld999/CustomWidgets/seek_bar.dart';
import 'package:wrld999/CustomWidgets/snackbar.dart';
import 'package:wrld999/CustomWidgets/textinput_dialog.dart';
import 'package:wrld999/Helpers/config.dart';
import 'package:wrld999/Helpers/dominant_color.dart';
import 'package:wrld999/Helpers/lyrics.dart';
import 'package:wrld999/Helpers/mediaitem_converter.dart';
import 'package:wrld999/Screens/Common/song_list.dart';
import 'package:wrld999/Screens/Search/albums.dart';
...
class NameNControls extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double seekBoxHeight =
        (height > 500 ? height * 0.15 : height * 0.2).clamp(80.0, double.infinity);
    final double nowplayingBoxHeight = min(70, height * 0.15);
    final double maxControlBoxHeight = offline
        ? height > 500
            ? height * 0.2
            : height * 0.25
        : (height < 350
    ...
    final double controlBoxHeight =
        (height - titleBoxHeight - seekBoxHeight - nowplayingBoxHeight)
            .clamp(0.0, maxControlBoxHeight);
