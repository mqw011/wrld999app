...
import 'package:wrld999/Helpers/spotify_helper.dart';
// import 'package:wrld999/Helpers/countrycodes.dart';
import 'package:wrld999/Screens/Search/search.dart';
import 'package:wrld999/Screens/Settings/setting.dart';
                  ...
                  return TopPage(
                    type: box
                        .get(
                          'region',
                          defaultValue:
                              box.get('lang', defaultValue: 'English') ==
                                      'Russian'
                                  ? 'Kazakhstan'
                                  : 'India',
                        )
...
Future<void> scrapData(String type, {bool signIn = false}) async {
  ...
  if (accessToken == null) {
    try {
      ...
      debugPrint('Could not launch Spotify auth URL: $e');
    }
