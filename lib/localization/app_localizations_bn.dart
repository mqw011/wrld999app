...
class AppLocalizationsBn extends AppLocalizations {
  ...
  String get checkUpdateSub =>
      'আপনি যদি \'F-Droid\', \'IzzyOnDroid\' ইত্যাদি যেকোন অ্যাপ রিপোজিটরি থেকে wrld999 ডাউনলোড করে থাকেন যা আপডেট অপশন প্রদান করে, তাহলে এটি বন্ধ রাখুন। আপনি যদি \'GitHub\' বা অন্য কোনো উৎস থেকে এটি ডাউনলোড করেন যা স্বয়ংক্রিয় আপডেট প্রদান করে না, তাহলে এটি চালু করুন, যাতে আপডেট সতর্কতা পেতে পারেন\n';
  ...
  String get countryQue =>
      'কোন দেশের জন্য আপনি স্পটিফাই স্থানীয় চার্ট দেখতে চান?';
  ...
  String get downFilenameSub =>
      'গান এই ফাইলনাম বিন্যাস অনুযায়ী ডাউনলোড করা হবে';
  ...
  String get enforceRepeatSub =>
      'প্রতি সেশনের জন্য একই পুনরাবৃত্তি সেটিং রাখুন';
